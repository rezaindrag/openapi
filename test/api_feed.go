...
func (r ApiFetchFeedRequest) Execute() ([]Feed, *_nethttp.Response, error) {
 ...
 */
func (a *FeedApiService) FetchFeed(ctx _context.Context) ApiFetchFeedRequest {
	return ApiFetchFeedRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return []Feed
 */
func (a *FeedApiService) FetchFeedExecute(r ApiFetchFeedRequest) ([]Feed, *_nethttp.Response, error) {
	var (
